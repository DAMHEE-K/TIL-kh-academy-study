...
<div id="demo-container" 
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="submit('dev4');" class="list-group-item list-group-item-action">파라미터 핸들링 - 유효성 검사</button>
	  <button type="button" onclick="submit('createDev');" class="list-group-item list-group-item-action">DB 등록</button>
	</div>
</div>
<script>
const submit = (path) => {
