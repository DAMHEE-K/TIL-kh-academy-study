...
<div id="demo-container" 
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="submit('dev3');" class="list-group-item list-group-item-action">파라미터 핸들링 - 커맨드객체</button>
	  <button type="button" onclick="submit('dev4');" class="list-group-item list-group-item-action">파라미터 핸들링 - 유효성검사</button>
	  <button type="button" onclick="submit('createDev');" class="list-group-item list-group-item-action">DB등록</button>
	</div>
</div>
<script>
const submit = (path) => {
