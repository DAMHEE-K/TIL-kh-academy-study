...
<div id="update-container">
	<%-- principal을 loginMember 변수에 저장해서 사용할 수도 있음 --%>
	...
	<form:form name="memberUpdateFrm" action="${pageContext.request.contextPath}/member/memberUpdate.do" method="post">
		...
		<input type="date" class="form-control" placeholder="생일" value='<sec:authentication property="principal.birthday"/>' name="birthday" id="birthday"/>
