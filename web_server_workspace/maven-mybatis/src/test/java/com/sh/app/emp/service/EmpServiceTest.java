...
class EmpServiceTest {
	...
	@DisplayName("사원 검색 시 searchType, searchKeyword가 null 또는 ''인 경우")
	@ParameterizedTest
	@CsvSource(value = {
		"null, null",
		"'', 동",
	...
	void testSerarchTypeIsNullOrSearchKeywordIsNull(String searchType, String searchKeyword) throws Exception {
		// given
	...
	@DisplayName("성별값이 없거나 급여값이 없는 경우 사원 조회")
	@ParameterizedTest
	@CsvSource(value = {
			"null, 2_000_000, ge",
			"남, null, null",
	...
	@DisplayName("직급코드가 null인 경우 사원 전체 조회")
	@ParameterizedTest
	@NullSource
