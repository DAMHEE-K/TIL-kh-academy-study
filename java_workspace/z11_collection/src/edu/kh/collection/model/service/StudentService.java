...
public class StudentService {
	...
	public void ex() {
		...
		// 실행 후 : 알고 보니 0번째는 Student 객체이고, toString()이 오버라이딩이 되어있음
	...
	public void displayMenu() {
		...
		do {
			...
			default : System.out.println("메뉴에 작성된 번호만 입력해주세요.");
				...
				menuNum = -1; // 첫 반복 시 잘못 입력하는 경우 menuNum이 0을 갖고 있어 종료되는데
	...
	public String updateStudent() throws InputMismatchException {
		...
		//   -> 반환값 Student == 변경 전 Student 객체가 담겨 있다
		...
		// 1) 학생 정보가 studentList에 있는가?
			...
			// 4) 입력 받은 숫자가 studentList 범위 내 인덱스 번호인가?
				...
				// 이때, index 번째에 있던 기존 학생 정보가 반환된다.
	...
	public void searchName2() {
		...
		System.out.print("이름에 포함되는 문자열 입력 입력 : ");
		String input = sc.next();
