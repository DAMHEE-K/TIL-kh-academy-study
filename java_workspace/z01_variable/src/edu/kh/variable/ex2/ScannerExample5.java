...
public class ScannerExample5 {
	public static void main(String[] args) {
		...
		System.out.print("입력 : ");
		String str = sc.nextLine(); // next() : hello
		...
		//					입력버퍼				nextXXX()			후처리
		// nextLin() :  hello world(엔터) -> hello world(엔터) -> 남은 (엔터) 제거
		
		// nextInt() : 		100(엔터)     ->        100       -> 후처리x
		
		// *** next(), nextDouble(), nextInt() 등은
		...
		// 추가적인 입력을 시도하지 못하고 다음 코드로 넘어가는 문제가 발생
