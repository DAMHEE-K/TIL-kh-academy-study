 ...
 * - 임계영역(Critical Section) : 한번에 하나의 쓰레드만 사용하는 공유 자원. Lock을 획득한 쓰레드만 접근이 가능하다.
 * 
 * - 동기화처리1 : Synchronized 메소드로 작성 (해당 객체가 임계영역으로 설정됨)
 * - 동기화처리2 : Synchronized 블럭 작성 (임계영역 객체를 지정) ** 효율적인 방법 **
 */
public class ATMRunner {
	public static void main(String[] args) {
		Account acc = new Account(1000); // 1000원이 입금되어있는 계좌
